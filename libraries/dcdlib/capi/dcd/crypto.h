 ...
 *  dcd::print("sha256 hash generated from data equals provided hash");
 *  @endcode
 */
 ...
 *  dcd::print("sha1 hash generated from data equals provided hash");
 *  @endcode
 */
__attribute__((dcd_wasm_import))
 ...
 *  dcd::print("sha512 hash generated from data equals provided hash");
 *  @endcode
 */
__attribute__((dcd_wasm_import))
 ...
 *  dcd::print("ripemod160 hash generated from data equals provided hash");
 *  @endcode
 */
__attribute__((dcd_wasm_import))
 ...
 *  dcd_assert( calc_hash == hash, "invalid hash" );
 *  @endcode
 */
__attribute__((dcd_wasm_import))
 ...
 *  dcd::print("pub key matches the pub key generated from digest");
 *  @endcode
 */
__attribute__((dcd_wasm_import))
