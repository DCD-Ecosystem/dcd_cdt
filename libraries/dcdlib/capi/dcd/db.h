 ...
 *  @details Database C API provides low level interface to DCD database.
 *
...
/**
  ...
  *  dcd_assert(itr >= 0, "Alice cannot be removed since she was already not found in the table");
  *  db_remove_i64(itr);
  *  @endcode
  */
__attribute__((dcd_wasm_import))
...
/**
  ...
  *  dcd_assert(len <= 50, "buffer to small to store retrieved record");
...
/**
  ...
  *  dcd_assert(end_itr < -1, "Charlie was not the last entry in the table");
  *  @endcode
  */
__attribute__((dcd_wasm_import))
