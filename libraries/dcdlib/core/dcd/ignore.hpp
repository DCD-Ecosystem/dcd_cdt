...
namespace dcd {
   ...
   inline DataStream& operator<<(DataStream& ds, const ::dcd::ignore_wrapper<T>& val) {
     ds << val.value;
     return ds;
   }
    ...
    */
   template<typename DataStream, typename T>
   inline DataStream& operator<<(DataStream& ds, const ::dcd::ignore<T>& val) {
     return ds;
   }
    ...
    */
   template<typename DataStream, typename T>
   inline DataStream& operator>>(DataStream& ds, ::dcd::ignore<T>&) {
     return ds;
   }
}
