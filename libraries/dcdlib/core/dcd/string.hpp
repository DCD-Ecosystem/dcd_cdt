...
#include "datastream.hpp" // dcd::datastream
#include "varint.hpp"     // dcd::unsigned_int
...
namespace dcd {
   ...
   public:
      ...
      char& at(const size_t n) {
         dcd::check(0 <= n && n < _size, "dcd::string::at");
         return operator[](n);
      }

      const char at(const size_t n) const {
         dcd::check(0 <= n && n < _size, "dcd::string::at const");
         return operator[](n);
      }
      ...
      size_t copy(char* s, size_t len, size_t pos = 0) const {
         dcd::check(pos <= _size, "dcd::string::copy");
      ...
      string& insert(const size_t pos, const char* str, const size_t len) {
         dcd::check((str != nullptr) && (0 <= pos && pos <= _size), "dcd::string::insert");
      ...
      string& erase(size_t pos = 0, size_t len = npos) {
         dcd::check(0 <= pos && pos <= _size, "dcd::string::erase");
      ...
      string& append(const char* str) {
         dcd::check(str != nullptr, "dcd::string::append");
         insert(_size, str);
