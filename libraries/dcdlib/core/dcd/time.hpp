...
namespace dcd {
  ...
  class microseconds {
    public:
        ...
        int64_t _count;
        /// @endcond
        DCDLIB_SERIALIZE( microseconds, (_count) )
    private:
  ...
  class time_point {
    public:
        ...
        DCDLIB_SERIALIZE( time_point, (elapsed) )
  };
  ...
  class time_point_sec
  {
    public:
        ...
        DCDLIB_SERIALIZE( time_point_sec, (utc_seconds) )
  };
   ...
   **/
   class block_timestamp {
      public:
         ...
         DCDLIB_SERIALIZE( block_timestamp, (slot) )
      private:
