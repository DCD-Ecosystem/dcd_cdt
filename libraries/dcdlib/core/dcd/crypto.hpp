...
namespace dcd {
   ...
   /**
    *  Serialize an dcd::webauthn_public_key into a stream
    *
    *  @ingroup public_key
   ...
   inline DataStream& operator<<(DataStream& ds, const dcd::webauthn_public_key& pubkey) {
      ds << pubkey.key << pubkey.user_presence << pubkey.rpid;
      return ds;
   }

   /**
    *  Deserialize an dcd::webauthn_public_key from a stream
    *
    *  @ingroup public_key
    ...
    */
   template<typename DataStream>
   inline DataStream& operator>>(DataStream& ds, dcd::webauthn_public_key& pubkey) {
      ds >> pubkey.key >> pubkey.user_presence >> pubkey.rpid;
      return ds;
   }
   ...
   /**
    *  Serialize an dcd::webauthn_signature into a stream
    *
    *  @param ds - The stream to write
    ...
    */
   template<typename DataStream>
   inline DataStream& operator<<(DataStream& ds, const dcd::webauthn_signature& sig) {
      ds << sig.compact_signature << sig.auth_data << sig.client_json;
      return ds;
   }

   /**
    *  Deserialize an dcd::webauthn_signature from a stream
    *
    *  @param ds - The stream to read
    ...
    */
   template<typename DataStream>
   inline DataStream& operator>>(DataStream& ds, dcd::webauthn_signature& sig) {
      ds >> sig.compact_signature >> sig.auth_data >> sig.client_json;
      return ds;
   }
    ...
    */
   void assert_sha256( const char* data, uint32_t length, const dcd::checksum256& hash );
    ...
    *  @note This method is optimized to a NO-OP when in fast evaluation mode.
    */
   void assert_sha1( const char* data, uint32_t length, const dcd::checksum160& hash );
    ...
    *  @note This method is optimized to a NO-OP when in fast evaluation mode.
    */
   void assert_sha512( const char* data, uint32_t length, const dcd::checksum512& hash );
    ...
    *  @param hash - digest to compare to
    */
   void assert_ripemd160( const char* data, uint32_t length, const dcd::checksum160& hash );
    ...
    *  @param data - Data you want to hash
    *  @param length - Data length
    *  @return dcd::checksum256 - Computed digest
    */
   dcd::checksum256 sha256( const char* data, uint32_t length );
    ...
    *  @param data - Data you want to hash
    *  @param length - Data length
    *  @return dcd::checksum160 - Computed digest
    */
   dcd::checksum160 sha1( const char* data, uint32_t length );
    ...
    *  @param data - Data you want to hash
    *  @param length - Data length
    *  @return dcd::checksum512 - Computed digest
    */
   dcd::checksum512 sha512( const char* data, uint32_t length );
    ...
    *  @return dcd::checksum160 - Computed digest
    */
   dcd::checksum160 ripemd160( const char* data, uint32_t length );
    ...
    *  @param sig - Signature
    *  @return dcd::public_key - Recovered public key
    */
   dcd::public_key recover_key( const dcd::checksum256& digest, const dcd::signature& sig );
    ...
    */
   void assert_recover_key( const dcd::checksum256& digest, const dcd::signature& sig, const dcd::public_key& pubkey );
}
