 ...
 * @ingroup contracts
 * @ingroup types
 * @brief Defines contract type which is %base class for every DCD contract
 */
 ...
 * @ingroup contract
 */
#define CONTRACT class [[dcd::contract]]
#define ACTION   [[dcd::action]] void
#define TABLE struct [[dcd::table]]

namespace dcd {

/**
 * %Base class for DCD contract.
 *
 * @ingroup contract
 * @details %A new contract should derive from this class, so it can make use of DCD_ABI macro.
 */
class contract {
   public:
      /**
