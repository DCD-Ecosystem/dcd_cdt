   ...
   */
   ...
   struct blockchain_parameters {
      ...
      */
      ...
      DCDLIB_SERIALIZE( blockchain_parameters,
   ...
   struct kv_parameters {
      ...
      * @brief The maximum number of iterators
      ...
      DCDLIB_SERIALIZE( kv_parameters,
                        (max_key_size)
    ...
    */
   inline void set_kv_parameters(const dcd::kv_parameters& params) {
      ...
      char buf[sizeof(uint32_t) + sizeof(dcd::kv_parameters)];
