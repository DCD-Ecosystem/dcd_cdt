...
namespace  dcd {
    ...
    *  @ingroup contracts
    *  @brief Defines DCD Singleton Table used with %multiindex
    */
   ...
   class singleton
   {
      ...
      struct row {
         ...
         DCDLIB_SERIALIZE( row, (value) )
      };

      typedef dcd::multi_index<SingletonName, row> table;
      ...
      public:
         ...
         T get() {
            ...
            dcd::check( itr != _t.end(), "singleton does not exist" );
            return itr->value;
         }
