...
struct project {
   ...
   const std::string hpp = "#include <dcd/dcd.hpp>\n"
                           "using namespace dcd;\n\n"
   ...
   const std::string readme_cmake = "--- @ Project ---\n\n"
                                    ...
                                    "   - You can then do a 'set contract' action with 'cldcd' and point in to the './build/@' directory\n\n"
                                    " - Additions to CMake should be done to the CMakeLists.txt in the './src' directory and not in the top level CMakeLists.txt";

   const std::string readme_bare = " --- @ Project ---\n\n"
                                   " - How to Build -\n"
                                   "   - run the command 'dcd-cpp -abigen -o @.wasm @.cpp'\n";
...
int main(int argc, const char **argv) {
   ...
   cl::SetVersionPrinter([](llvm::raw_ostream& os) {
        os << "dcd-init version " << "@VERSION_FULL@" << "\n";
  });
   cl::OptionCategory cat("dcd-init", "generates an dcd smart contract project");
   ...
   cl::ParseCommandLineOptions(argc, argv, std::string("dcd-proj"));
   try {
