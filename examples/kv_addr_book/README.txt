--- kv_addr_book Project ---
 ...
 - After build -
   ...
   - You can then do a 'set contract' action with 'cldcd' and point to the './build/kv_addr_book' directory

 - Additions to CMake should be done to the CMakeLists.txt in the './src' directory and not in the top level CMakeLists.txt

 -- How to build with dcd-cpp --
   - cd into the 'build' directory
   - run the command 'dcd-cpp -abigen ../src/kv_addr_book.cpp -o kv_addr_book.wasm -I ../include/'
