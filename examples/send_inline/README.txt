--- send_inline Project ---
 ...
 - After build -
   ...
   - You can then do a 'set contract' action with 'cldcd' and point to the './build/send_inline' directory

 - Additions to CMake should be done to the CMakeLists.txt in the './src' directory and not in the top level CMakeLists.txt

 -- How to build with dcd-cpp --
   - cd into the 'build' directory
   - run the command 'dcd-cpp -abigen ../src/send_inline.cpp -o send_inline.wasm -I ../include/ -I ../../hello/include/'
