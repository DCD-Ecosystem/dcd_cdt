...
public:
  ...
  std::string getDcdABI() const { return dcdABI; }
  ArrayRef<StringRef> getDcdActions() const { return dcdActions; }
  ArrayRef<StringRef> getDcdNotify() const { return dcdNotify; }
...
private:
  ...
  std::string dcdABI;
  ArrayRef<StringRef> dcdActions;
  ArrayRef<StringRef> dcdNotify;
