...
bool RecordDecl::isDcdIgnore() const { return hasAttr<DcdIgnoreAttr>(); }
...
bool FunctionDecl::isDcdWasmABI()const { return hasAttr<DcdWasmABIAttr>(); }
std::string FunctionDecl::getWasmABI()const { return getAttr<DcdWasmABIAttr>()->getAbi(); }
bool FunctionDecl::isDcdWasmEntry()const { return hasAttr<DcdWasmEntryAttr>(); }
bool FunctionDecl::isDcdWasmImport()const { return hasAttr<DcdWasmImportAttr>(); }
bool FunctionDecl::isDcdWasmAction()const { return hasAttr<DcdWasmActionAttr>(); }
std::string FunctionDecl::getDcdWasmAction()const { return getAttr<DcdWasmActionAttr>()->getName(); }
bool FunctionDecl::isDcdWasmNotify()const { return hasAttr<DcdWasmNotifyAttr>(); }
std::string FunctionDecl::getDcdWasmNotify()const { return getAttr<DcdWasmNotifyAttr>()->getName(); }
