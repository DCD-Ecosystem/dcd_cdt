...
public:
  ...
  bool isDcdContract() const { return hasAttr<DcdContractAttr>(); }
  bool isDcdAction() const { return hasAttr<DcdActionAttr>(); }
  bool isDcdTable() const { return hasAttr<DcdTableAttr>(); }
  bool isDcdIgnore() const { return hasAttr<DcdIgnoreAttr>(); }
  bool hasDcdRicardian() const { return hasAttr<DcdRicardianAttr>(); }
  bool isDcdReadOnly() const { return hasAttr<DcdReadOnlyAttr>(); }
  DcdActionAttr* getDcdActionAttr() const { return getAttr<DcdActionAttr>(); }
  DcdTableAttr*  getDcdTableAttr() const { return getAttr<DcdTableAttr>(); }
  DcdContractAttr*  getDcdContractAttr() const { return getAttr<DcdContractAttr>(); }
  DcdRicardianAttr*  getDcdRicardianAttr() const { return getAttr<DcdRicardianAttr>(); }
  DcdReadOnlyAttr* getDcdReadOnlyAttr() const { return getAttr<DcdReadOnlyAttr>(); }
...
public:
  ...
  bool isDcdAction() const { return hasAttr<DcdActionAttr>(); }
  bool isDcdNotify() const { return hasAttr<DcdNotifyAttr>(); }
  bool isDcdContract() const { return hasAttr<DcdContractAttr>(); }
  bool hasDcdRicardian() const { return hasAttr<DcdRicardianAttr>(); }
  bool isDcdReadOnly() const { return hasAttr<DcdReadOnlyAttr>(); }
  DcdActionAttr* getDcdActionAttr() const { return getAttr<DcdActionAttr>(); }
  DcdNotifyAttr* getDcdNotifyAttr() const { return getAttr<DcdNotifyAttr>(); }
  DcdContractAttr* getDcdContractAttr() const { return getAttr<DcdContractAttr>(); }
  DcdRicardianAttr* getDcdRicardianAttr() const { return getAttr<DcdRicardianAttr>(); }
  DcdReadOnlyAttr* getDcdReadOnlyAttr() const { return getAttr<DcdReadOnlyAttr>(); }
