...
public:
  ...
  bool isDcdWasmABI()const;
  std::string getWasmABI()const;
  bool isDcdWasmEntry()const;
  bool isDcdWasmImport()const;
  bool isDcdWasmAction()const;
  std::string getDcdWasmAction()const;
  bool isDcdWasmNotify()const;
  std::string getDcdWasmNotify()const;
