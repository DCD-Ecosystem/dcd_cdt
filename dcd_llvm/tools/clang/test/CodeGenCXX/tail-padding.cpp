...
namespace Implicit {
  ...
  // CHECK: define {{.*}} @_ZN8Implicit1CC1DCD0_
...
namespace InitWithinNVSize {
  ...
  // CHECK: define {{.*}} @_ZN16InitWithinNVSize1CC1DCD0_
...
namespace NoUniqueAddr {
  ...
  // CHECK: define {{.*}} @_ZN12NoUniqueAddr1CC1DCD0_
  ...
  // CHECK: define {{.*}} @_ZN12NoUniqueAddr1DC1DCD0_
  // CHECK: call {{.*}} @_ZN12NoUniqueAddr1AC2ERKS0_(
  ...
  // CHECK: define {{.*}} @_ZN12NoUniqueAddr1EC1DCD0_
  // CHECK: call {{.*}} @_ZN12NoUniqueAddr1AC2ERKS0_(
