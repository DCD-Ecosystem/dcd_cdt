...
void move_VirtualWithEmptyBase(VirtualWithEmptyBase &x, VirtualWithEmptyBase &y) {
  // CHECK: call {{.*}} @_ZN20VirtualWithEmptyBaseaSDCD_
...
// CHECK-ASSIGN: define linkonce_odr {{.*}} @_ZN1DaSDCD_
// CHECK-ASSIGN: call {{.*}} @_ZN1CaSDCD_
// CHECK-ASSIGN: call {{.*}} @_ZN1AaSDCD_
// CHECK-ASSIGN: call {{.*}} @_ZN1BaSDCD_
// array loop
// CHECK-ASSIGN: br i1
// CHECK-ASSIGN: call {{.*}} @_ZN1AaSDCD_

// VirtualWithEmptyBase move assignment operatpr
// CHECK-ASSIGN: define linkonce_odr {{.*}} @_ZN20VirtualWithEmptyBaseaSDCD_
// CHECK-ASSIGN: store
// CHECK-ASSIGN-NEXT: store
// CHECK-ASSIGN-NOT: call
// CHECK-ASSIGN: ret

// CHECK-ASSIGN: define linkonce_odr {{.*}} @_ZN1CaSDCD_
// CHECK-ASSIGN: call {{.*}} @_ZN1AaSDCD_

// move ctors

// CHECK-CTOR: define linkonce_odr {{.*}} @_ZN1HC2DCD_
// CHECK-CTOR: call {{.*}} @_ZN1GC2DCD_
// CHECK-CTOR: call {{.*}} @_ZN1FC1DCD_
// CHECK-CTOR: call {{.*}} @_ZN1EC1DCD_
// array loop
// CHECK-CTOR: call {{.*}} @_ZN1FC1DCD_
// CHECK-CTOR: br i1

// CHECK-CTOR: define linkonce_odr {{.*}} @_ZN1GC2DCD_
// CHECK-CTOR: call {{.*}} @_ZN1EC1DCD_
