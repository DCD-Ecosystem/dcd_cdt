...
struct D1 : public B {
   const int i{};
   DCDLIB_SERIALIZE_DERIVED( D1, B, (i) )
...
struct D2 : public D1 {
   ...
   DCDLIB_SERIALIZE_DERIVED( D2, D1, (v) )
...
// Definitions in `dcd.cdt/libraries/dcd/serialize.hpp`
DCD_TEST_BEGIN(serialize_test)
