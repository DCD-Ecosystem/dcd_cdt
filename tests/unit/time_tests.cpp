...
// Definitions in `dcd.cdt/libraries/dcd/time.hpp`
DCD_TEST_BEGIN(microseconds_type_test)
...
// Definitions in `dcd.cdt/libraries/dcd/time.hpp`
DCD_TEST_BEGIN(time_point_type_test)
...
// Definitions in `dcd.cdt/libraries/dcd/time.hpp`
DCD_TEST_BEGIN(time_point_sec_type_test)
   static const microseconds ms0 { 0LL};
   static const microseconds ms1 { 1LL};
   static const microseconds msn1{-1LL};
   static const microseconds ms_min{i64min};
...
// Definitions in `dcd.cdt/libraries/dcd/time.hpp`
DCD_TEST_BEGIN(block_timestamp_type_test)
...
int main(int argc, char* argv[]) {
   ...
   DCD_TEST(microseconds_type_test);
   DCD_TEST(time_point_type_test);
   DCD_TEST(time_point_sec_type_test);
   DCD_TEST(block_timestamp_type_test);
   return has_failed();
}
