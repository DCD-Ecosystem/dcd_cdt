...
// Definitions in `dcd.cdt/libraries/dcd/symbol.hpp`
DCD_TEST_BEGIN(symbol_code_type_test)
...
// Definitions in `dcd.cdt/libraries/dcd/symbol.hpp`
DCD_TEST_BEGIN(symbol_type_test)
...
// Definitions in `dcd.cdt/libraries/dcd/symbol.hpp`
DCD_TEST_BEGIN(extended_symbol_type_test)
...
int main(int argc, char* argv[]) {
   ...
   DCD_TEST(symbol_code_type_test);
   DCD_TEST(symbol_type_test);
   DCD_TEST(extended_symbol_type_test);
   return has_failed();
}
