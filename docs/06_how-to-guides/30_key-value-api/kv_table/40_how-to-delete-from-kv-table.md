...
Use the method `erase` defined by the `dcd::kv::table` type to accomplish this task.
...
class [[dcd::contract]] smrtcontract : public contract {
  ...
  public:
     ...
     using del_action = dcd::action_wrapper<"del"_n, &smrtcontract::del>;
};
```
...
```cpp
[[dcd::action]]
void smrtcontract::delete(dcd::name account_name) {
