---
content_title: dcd-cpp tool
---

To manually compile the source code, use `dcd-cpp` and `dcd-ld` as if it were __clang__ and __lld__. All the includes and options specific to DCD and CDT are baked in.

```
USAGE: dcd-cpp [options] <input file> ...
