---
content_title: dcd-cc tool
---

To manually compile the source code, use `dcd-cc` and `dcd-ld` as if it were __clang__ and __lld__. All the includes and options specific to DCD and CDT are baked in.

```
USAGE: dcd-cc [options] <input file> ...
