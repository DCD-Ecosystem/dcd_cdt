...
def main():
    if len(sys.argv) == 1:
        print('Please specify an operation of export or import: ./ricarddcd.py <import|export>')
        sys.exit(1)

    if sys.argv[1] == 'import':
        if len(sys.argv) < 4:
            print('Please specify a source and destination abi:')
            print('Usage: ./ricarddcd.py import /dcd/contracts/contract/mycontract.abi /dcd/contracts/contract/withricardian-mycontract.abi')
        ...
        if len(sys.argv) < 3:
            ...
            print('Usage: ./ricarddcd.py export /dcd/contracts/contract/mycontract.abi')
